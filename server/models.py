...
#Association table to store many to many relationship btwn employees and meetings
...
class Employee(db.Model):
    ...
    #relationship btw employee and related meetings
...
class Meeting(db.Model):
    ...
    #relationship btwn meeting and related employees
